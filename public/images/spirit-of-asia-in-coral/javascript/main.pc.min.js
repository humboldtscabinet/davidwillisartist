...
initDefaultDom:function(){this.close=$("<div class='close' style='background-image:url("+this.closeUrl+")'></div>");this.close.on("click",this.hide.bind(this));this.leftPageNum=$("<div class='page_num left'></div>");this.rightPageNum=$("<div class='page_num right'></div>");this.initSwiper()},initSwiper:function(){this.thumbnailSwiper=$("<div class='thumbnailSwiper stage'></div>");this.thumbnailSwiperList=$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");this.progressBar=
$("<div class='progressBar'></div>");this.refreshSwiper(this.thumbnailSwiperList);this.thumbnailSwiper.append(this.thumbnailSwiperList);this.thumbnailSwiper.append(this.progress);this.progress.append(this.progressBar)},initEvent:function(){this.stage.bind("mousedown touchstart",function(a){a.stopPropagation()});rightToLeft?this.thumbnailSwiper.scroll({},Direction.right):this.thumbnailSwiper.scroll({},Direction.left)},onResize:function(){if(this.thumbnailSwiperList.width()<.9*windowWidth-220){var a=
this.thumbnailSwiperList.width()+220;this.stage.css({width:a+"px",left:(windowWidth-a)/2+"px"})}else this.stage.css({width:"90%",left:"5%"});this.refresh()},refresh:function(){this.thumbnailSwiper.refreshData()},refreshSwiper:function(a){this.itemArray=[];this.thumbnailSwiperList.empty();this.length=this.margin;if(BookInfo.isDoublePage())for(var b=BookInfo.getThumbnailPages(),c=0;c<b.length;c++)this.addItem(a,b[c]);else for(c=1;c<=bookConfig.totalPageCount;c++)this.addItem(a,[c]);a.css("width",this.length+
"px");this.setHighLight(BookInfo.getCurrentPageIndex())},mergeAll:function(){this.isMerge!=BookInfo.isDoublePage()&&this.refreshSwiper(this.thumbnailSwiperList);this.isMerge=!0;for(var a=0;a<this.itemArray.length;a++)this.itemArray[a].merge()},fissionAll:function(){this.isMerge!=BookInfo.isDoublePage()&&this.refreshSwiper(this.thumbnailSwiperList);this.isMerge=!1;for(var a=0;a<this.itemArray.length;a++)this.itemArray[a].fission()},addItem:function(a,b){a=new ThumbnailPoint(a,b);a.setPosition(this.length,
this.direction);this.length+=a.getLength();this.length+=this.margin;this.itemArray.push(a)},clearHighLight:function(){$(".highlight").removeClass("highlight")},setHighLight:function(a){$(".highlight").removeClass("highlight");var b=BookInfo.getCurrentPages();1==b.length?BookInfo.isLeftPage(a)?(this.leftPageNum.html(getShownPageNumber(b[0])),this.rightPageNum.html("")):(this.leftPageNum.html(""),this.rightPageNum.html(getShownPageNumber(b[0]))):(this.leftPageNum.html(getShownPageNumber(b[0])),this.rightPageNum.html(getShownPageNumber(b[1])));
for(b=0;b<this.itemArray.length;b++)0<=this.itemArray[b].pages.indexOf(a)&&this.itemArray[b].setHighLight(a);this.thumbnailSwiper.animateToCenterItem&&window.setTimeout(this.thumbnailSwiper.animateToCenterItem,10)},getShowStatu:function(){return this.visible},getHeight:function(){return this.getTopHeight()+this.getBottomHeight()},getTopHeight:function(){return 0},getBottomHeight:function(){return this.visible?45:0},showOrHide:function(){this.visible?this.hide():this.show()},show:function(){bookConfig.ToolBarVisible&&
...
singlePage:"",doublePage:""};Class("ButtonQueue",{create:function(a){this.container=a.container;this.extended=a.extended;this.edtNumber=a.edtNumber?a.edtNumber:{body:null,width:0,top:0,space:0};this.buttonWidth=a.buttonWidth;this.buttonTop=a.buttonTop;this.buttons=a.buttons.clone();this.buttonCount=this.buttons.length-1;this.buttons.each(function(b){b.freedom();b.hint=!0});this.pickButtons()},pickButtons:function(){this.btnFirst=this.buttons.find("first").get(0);this.btnPrevious=this.buttons.find("previous").get(0);this.btnNext=
...
b(this.btnFirst),bookConfig.enablePageBack&&b(this.btnBackward)):(bookConfig.enablePageBack&&b(this.btnBackward),b(this.btnFirst),b(this.btnPrevious),b(this.btnNext),b(this.btnLast),bookConfig.enablePageBack&&b(this.btnForward));return d}}).extend("ButtonQueue");Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{BUTTON_WIDTH:30,initBar:function(){this.removeButton("thumbnail");this.topBar=$('<div class="fbTopBar" id = "fbTopBar"></div>');this.logoBar=$("<div id='logoBar' class='logoBar'></div>");this.buttonBar=$("<div class='buttonBar'></div>");this.pageBar=$("<div class='pageBar'></div>");this.edtPageNumber=$("<div class='pageNumber' id='tfPageIndex'>\n\t\t\t\t<label for=\"currentPageIndexTextField\" class=\"sr-only\">\n          "+getLanguage("ariaPageNumber","page number")+"\n\t\t\t\t</label>\n        <input \n        aria-label='"+
getLanguage("ariaPageNumber","page number")+"' \n        autocomplete='off' type='text' id='currentPageIndexTextField' size='13' />\n\t\t\t</div>");this.btnGotoPage=$("<div class='btnGotoPage'>GO</div>");VolumeControlBar.config={color:this.color.rgba(.5),iconColor:Color(bookConfig.iconColor).toString(),direction:VolumeControlBar.BOTTOM};this.parent.append(this.topBar);this.parent.append(this.logoBar);this.topBar.append(this.buttonBar);this.topRightBar=$('<div class="topRightBar" id = "topRightBar"></div>');
this.topRightBar.append(this.pageBar);this.parent.append(this.topRightBar);this.pageBar.append(this.edtPageNumber);this.pageBar.append(this.btnGotoPage);this.initStyle();this.initPageNumber()},initStyle:function(){this.topBar.css({"background-color":this.color.rgba(.5*this.topBarAlpha)});this.pageBar.css({"background-color":this.color.rgba(.5*this.bottomBarAlpha)})},initPageNumber:function(){var a=this.edtPageNumber.find("input");a.css({color:Color(bookConfig.pageNumColor).toString()});this.btnGotoPage.css({color:Color(bookConfig.iconColor).toString()});
...
new PcTelephoneNumberBubble({parent:this.parent,color:this.color,textColor:a.fontColor,margin:4,padding:15,arrowHeight:8,arrowWidth:8});else{var b=new SolidArrowTextBubble({parent:this.parent,text:a.caption,color:this.color,textColor:a.fontColor});a.setTitle(b)}},initExtendedbar:function(){this.extendedBar=new PCExtendedBar(this.parent);global.moreBar=this.extendedBar},initEvents:function(){bookConfig.ToolBarVisible&&(this._super(),this.btnGotoPage.bind("click",function(){var a=this.edtPageNumber.find("input").val();
""!=a.trim()&&(a=parseInt(getRealPage(a)),isNaN(a)||gotoPageFun(a,!1,"input"))}.bind(this)))},getLeftWidth:function(){return 10},getRightWidth:function(){return 10},addTopRightButton:function(){this.topRightButton||(this.topRightButton=$("<div class='topRightButton' id='createButton'></div>"),bookConfig.ToolBarVisible?(this.topRightBar.append(this.topRightButton),this.onResize()):this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),
this.topRightButton=null)},onResize:function(a,b){if(bookConfig.ToolBarVisible){void 0==a&&(a=this.parent.width());void 0==b&&(b=this.parent.height());this.parentWidth=a;this.parentHeight=b;b=this.logoBar.width()+20;var c=this.topRightBar.width()+60;var d=Number.between(a-2*Math.max(b,c),4*(this.BUTTON_WIDTH+5)+20,(this.buttons.length-1)*(this.BUTTON_WIDTH+5));a=(a-d)/2;this.topBar.css({left:a+"px",width:d+"px"});this.buttonBar.css({width:d-10+"px"});a<c?this.topRightBar.css({display:"none"}):this.visible&&
this.topRightBar.css({display:"flex"});a<b?this.logoBar.hide():(this.visible&&this.logoBar.show(),this.logoBar.css({left:a-b+"px"}));this.resetButtonPosition()}},resetButtonColor:function(){this._super();this.iconColor=Color(bookConfig.iconColor);this.btnGotoPage.css({color:this.iconColor.toString()})},resetButtonPosition:function(){(new PCButtonQueue({buttons:this.buttons,buttonWidth:this.BUTTON_WIDTH,buttonTop:0,container:{body:this.buttonBar,width:this.buttonBar.width()},extended:this.extendedBar.$bar})).sort();
this.resizeButtonBar();this.extendedBar.resize(this.buttonsInExtendedBar());this.extendedBar.hide();this.buttons.each(function(a){a.changeColor();a.$button.asButton()}.bind(this))},resizeButtonBar:function(){var a=this.getButtonBarWidth();this.topBar.css({left:(this.parentWidth-a)/2+"px",width:a+"px"})},getButtonBarWidth:function(){for(var a=20,b=0;b<this.buttons.length;b++)this.buttons.get(b).$parent==this.buttonBar&&(a+=this.BUTTON_WIDTH);return a},show:function(){bookConfig.ToolBarVisible&&(this._super(),
this.onResize())},hide:function(){bookConfig.ToolBarVisible&&(this._super(),this.logoBar.hide(),this.pageBar.css({display:"none"}))}}).extend("Toolbar");
