...
const slides = [
  {
    src: "/images/coral-face-01.jpg",
    alt: "Coral mask sculpture with open mouth and textured surface",
    title: "Coral Mask — Open Expression",
  },
  {
    src: "/images/coral-face-02.jpg",
    alt: "Smooth coral sun face sculpture smiling gently",
    title: "Sun Face — Gentle Smile",
  },
  {
    src: "/images/coral-face-03.jpg",
    alt: "Coral sculpture with closed eyes and rounded cheeks",
    title: "Quiet Coral Portrait",
  },
  {
    src: "/images/coral-face-04.jpg",
    alt: "Large coral face sculpture on a metal shelf with serene expression",
    title: "Shelf Study — Serenity",
  },
  {
    src: "/images/coral-face-05.jpg",
    alt: "Reclining coral figure with closed eyes and soft features",
    title: "Reclining Coral Figure",
  },
  {
    src: "/images/coral-face-06.jpg",
    alt: "Coral face sculpture in a studio setting with rounded cheeks",
    title: "Studio Coral Portrait",
  },
  {
    src: "/images/coral-face-07.jpg",
    alt: "Coral turtle sculpture with textured shell",
    title: "Coral Turtle Form",
  },
  {
    src: "/images/coral-face-08.jpg",
    alt: "Textured coral face sculpture with deep-set features",
    title: "Textured Coral Visage",
  },
  {
    src: "/images/coral-face-09.jpg",
    alt: "Outdoor stone figure with clasped hands and serene face",
    title: "Garden Figure — Quiet Joy",
  },
  {
    src: "/images/coral-face-10.jpg",
    alt: "Outdoor stone face sculpture smiling in sunlight",
    title: "Sunlit Stone Smile",
  },
];
